...
class FirstPersonController(Entity):
    def __init__(self,forward_key = "w",backward_key = "s",left_key = "a",right_key = "d",jump_key = "space",speed = 5,height = 3,direction_x = 0,direction_y = 0,direction_z = 0, **kwargs):
...
##        self.rotation_z = direction_z
        ...
        camera.rotation = (direction_x,direction_y,direction_z)
        camera.fov = 100
        mouse.locked = True 
